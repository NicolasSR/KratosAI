...
if __name__ == "__main__":
    ...
    ae_config = {
        ...
        "batch_size": 1,
        "epochs": 500,
        "normalization_strategy": 'channel_range',  # ['channel_range']
        ...
        "residual_norm_factor": ('const',100),
        "dataset_path": 'datasets_low/',
        "models_path": 'saved_models_conv2d_proof/',
        "finetune_from": None,
    ...
    history = kratos_network.train_network(autoencoder, S_train, (S_flat_orig_train,R_train,F_train), S_test, (S_flat_orig_test,R_test,F_test), ae_config)
    print("Model trained")
