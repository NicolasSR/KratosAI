...
if __name__ == "__main__":
    ...
    data_path='saved_models_conv2d_experimental/'
    ...
    # def calculate_R_norm_error(S_input, F_true):
    #     S_pred_norm=autoencoder(S_input).numpy()
    #     R_pred=autoencoder.get_r_array(S_pred_norm, F_true)
    #     l2_error=mean_l2_error(R_pred,0)
    #     forb_error=forbenius_error(R_pred,0)
    #     print('Residual. Mean L2 error l:', l2_error)
    #     print('Residual. Forb. error l:', forb_error)

    def calculate_R_norm_error(S_input, R_true, F_true):
        R_true=R_true/1e9
        S_pred_norm=autoencoder(S_input).numpy()
        R_pred=autoencoder.get_r_array_full(S_pred_norm, F_true)
    ...
    def print_x_and_r_vecs(sample_id):
        ...
        r_pred=autoencoder.get_r_array_full(x_pred_norm,np.expand_dims(F[sample_id], axis=0))
        print('x_orig:', x_orig)
